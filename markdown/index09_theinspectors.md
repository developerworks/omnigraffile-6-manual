...
![Click the title of an inspector thats closed to open it up](HelpImages/og6_inspectors_useof.png)
...
![The Fill Inspector](HelpImages/og6_inspectors_01_fillinspector.png)
...
![The Stroke Inspector](HelpImages/og6_inspectors_02_strokeinspector.png)
...
![The Shadow Inspector](HelpImages/og6_inspectors_03_shadowinspector.png)
...
![The Shapes Inspector](HelpImages/og6_inspectors_04_shapesinspector.png)
...
![The Lines Inspector](HelpImages/og6_inspectors_05_linesinspector.png)
...
![The Image Inspector](HelpImages/og6_inspectors_06_imageinspector.png)
...
![The Geometry Inspector](HelpImages/og6_inspectors_07_geometryinspector.png)
...
![Additional geometry controls for labels](HelpImages/og6_inspectors_07_geometry_labels.png)
...
![The Alignment Inspector](HelpImages/og6_inspectors_08_alignmentinspector.png)
...
![The Font Inspector](HelpImages/og6_inspectors_09_fontinspector.png)
...
![The Text Inspector](HelpImages/og6_inspectors_10_textinspector.png)
...
![The Offset Inspector](HelpImages/og6_inspectors_11_offsetsinspector.png)
...
![The Connections Inspector](HelpImages/og6_inspectors_12_connectionsinspector.png)
...
![The Note Inspector](HelpImages/og6_inspectors_13_noteinspector.png)
...
The **Action inspector** determines what should happen when someone clicks the selected object with the Action Browse Tool ![The Action Browse Tool](HelpImages/og6_toolpalette_12_browsetool.png) in the toolbar. The default action is Does Nothing. You can click the object all you want, and nothing happens.

![The Action Inspector](HelpImages/og6_inspectors_14_actioninspector.png)
...
![The Canvas Size Inspector](HelpImages/og6_inspectors_15_canvassizeinspector.png)
...
![The Canvas Fill Inspector](HelpImages/og6_inspectors_16_canvasfillinspector.png)
...
![The Background Image Inspector](HelpImages/og6_inspectors_17_backgroundimageinspector.png)
...
![The Unit Inspector](HelpImages/og6_inspectors_18_unitsinspector.png)
...
![The Grid Inspector](HelpImages/og6_inspectors_19_gridinspector.png)
...
![The Canvas Data Inspector](HelpImages/og6_inspectors_20_canvasdatainspector.png)
...
![The Diagram Layout Inspector, showing the options for a Hierarchical layout](HelpImages/og6_inspectors_21_diagramlayoutinspector.png)
...
![The Diagram Layout Inspector, showing the options for a Force-directed layout](HelpImages/og6_inspectors_21_diagramlayout_forcedirected.png)

Circular
:   The circular layout tries to arrange sibling shapes in a circle around their parent.

![The Diagram Layout Inspector, showing the options for a Circular layout](HelpImages/og6_inspectors_21_diagramlayout_circular.png)

Radial
:   The radial layout tries to arrange sibling shapes in arcs around their parent.

![The Diagram Layout Inspector, showing the options for a Radial layout](HelpImages/og6_inspectors_21_diagramlayout_radial.png)
...
![The Format Inspector](HelpImages/og6_inspectors_22_formatinspector.png)
...
![The Margins Inspector](HelpImages/og6_inspectors_23_marginsinspector.png)
...
![The Document Data Inspector](HelpImages/og6_inspectors_24_documentdatainspector.png)
...
![The default top-level view of the Stencils Library](HelpImages/og6_stencils_01_defaultview.png)
...
![The Style Tray](HelpImages/og6_styletray.png)
...
![The origin point can be dragged out to any other position on the canvas](HelpImages/og6_ruleroriginpoint.png)
...
![Rulers and Inspector bar](HelpImages/og6_rulersandinspectorbar_01.png)
...
![Choose a template from the Resource Browser](HelpImages/og6_resourcebrowser_templates.png)
...
Two features that all of the preference panes offer are the ability to **Reset** (![The Reset button](HelpImages/og6_button_reset.png)) any changes you’ve made to the defaults settings, and quick access to **Help** (![The Help button](HelpImages/og6_button_help.png)) documentation for that pane.
...
![OmniGraffles General preference pane](HelpImages/og6_prefs_general.png)
...
![OmniGraffles Drawing Tools preference pane](HelpImages/og6_prefs_drawingtools.png)
...
![OmniGraffles Presentation preference pane](HelpImages/og6_prefs_presentation.png)
...
![OmniGraffles Update preferences](HelpImages/og6_prefs_update.png)
