...
![Tools](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_tools_shape.png)
...
![Drawing a shape](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_basicshape.png)
...
To select an object, first make sure you are using the **Selection** tool (![The Selection Tool](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_tools_selection.png)), and then click the object. When the object is highlighted—and if it can be resized—you will see eight handles along its edges.

![Select an object to resize by dragging one of the eight handles](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects01.png)
...
![Select and then drag one of the resizing handles to resize an object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects05.png)
...
![Use the Command key to select or deselect multiple objects](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects06.png)
...
![Use click-and-drag to select multiple objects on the canvas](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects04.png)
...
![Rotating an object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects02.png)
...
![Option-drag an object to duplicate an object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects03.png)
...
![Smart Guides help you align objects as you move them around on the canvas](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_resizeobjects07.png)
...
-   To group several objects together so they can be moved or styled as a single unit, select all of the objects and choose **Arrange \> Group** (**Shift-⌘-G**).
    ...
    ![Grouped objects can be styled and moved around as a single unit](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_groupobjects.png)
...
![Combine two or more objects using the Shapes Object inspector](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/0g6_drawingbasics_combinedobjects.png)

## Connecting Objects with Lines {#ConnectingObjectsWithLines}

You can connect any two objects with the **Line** tool (![The Line Tool](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_tools_line.png)).

1.  Select the Line tool. (Note, this tool might look different if you change its style.)

    ![Select the Line tool](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect01.png)

2.  Click the first object you would like to connect; this object becomes the *source* of the line.

    ![Click on the first object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect02.png)

3.  Click the second object you would like to connect; this object becomes the *destination* of the line.

    ![Then click on the second object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect03.png)
...
4.  When the objects are connected with a line, they stay connected no matter how much you change or move them around. That means the logical integrity of your diagram is preserved regardless of how you choose to style the objects.
    ...
    ![Once connected with a line, they are bound to one another](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect04.png)
...
5.  You can disconnect a line from an object by selecting the line and then dragging one of its end points. To delete the line, just select the line and hit **Delete**.
    ...
    ![Disconnecting lines](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect05.png)

    ![Disconnecting lines](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_lineconnect06.png)
...
1.  Select the object on the canvas.
    ...
    ![Select the object](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_editobject01.png)

2.  Select the Object Inspector (**⌘–1**) in the right sidebar.

    ![Select the Object Inspector](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_editobject02.png)
...
3.  The **Fill** inspector has two controls: Fill type on the left, and Fill color on the right. For now, let’s leave the Fill type alone, and just select a color to fill the inside of the object.
    ...
    ![Select the Fill Color control](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_editobject03.png)

4.  Use the Colors panel to choose a new fill color for the object.

    ![Select the Fill Color control](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_editobject04.png)

5.  Your object has a new fill color! Yeah!

    ![Select the Fill Color control](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_editobject05.png)
...
1.  Create a single shape object to be the first cell of your table.
    ...
    ![Create a basic shape for the table](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_tables01.png)
...
2.  With the object selected, choose **Arrange \> Make Table** (**Shift-⌘-T**). Notice the grid-like handles on the top, bottom, left, and right sides of the object; this lets you know the object is a table.
    ...
    ![Notice the grid-like handles on the top, bottom, left, and right sides of the object; this lets you know the object is a table](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_tables02.png)

3.  Drag the right-side table handle to the right to add columns.

    ![Drag the left or right handles to create additional columns](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_tables03.png)

4.  Drag the bottom table handle down to add rows.

    ![Drag the bottom or top handles to add rows](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_tables04.png)
...
![Select objects and then choose Make Tables from the Arrange menu to combine and convert those objects into a table](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_tables05.png)
...
1.  Select some objects on the canvas.
    ...
    ![Select the objects you want to create a subgraph from](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_subgraph01.png)

2.  With the objects selected, choose **Arrange \> Group as Subgraph**. Your objects are enclosed by a subgraph rectangle.

    ![](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_subgraph02.png)

3.  Style and label the enclosing rectangle however you like.

    ![](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_subgraph03.png)
...
![An expanded and collapsed subgraph](https://github.com/developerworks/omnigraffile-6-manual/blob/master/images/og6_drawingbasics_subgraph04.png)
